...
public class IdentificationTable {
	...
	public IdentificationTable() {
		...
		this.table.put(new Key(0, "writeln"), null);
		...
		this.table.put(new Key(0, "var"), null);
		
//		Puts in the table each language reserved word
//		this.table.put(new Key(0, "void"), GrammarSymbols.VOID);
//		this.table.put(new Key(0, "integer"), GrammarSymbols.INT);
//		this.table.put(new Key(0, "boolean"), GrammarSymbols.BOOL);
//		this.table.put(new Key(0, "if"), GrammarSymbols.IF);
//		this.table.put(new Key(0, "else"), GrammarSymbols.ELSE);
//		this.table.put(new Key(0, "while"), GrammarSymbols.WHILE);
//		this.table.put(new Key(0, "return"), GrammarSymbols.RETURN);
//		this.table.put(new Key(0, "break"), GrammarSymbols.BREAK);
//		this.table.put(new Key(0, "continue"), GrammarSymbols.CONTINUE);
//		this.table.put(new Key(0, "writeln"), GrammarSymbols.WRITELN);
//		this.table.put(new Key(0, "false"), GrammarSymbols.FALSE);
//		this.table.put(new Key(0, "true"), GrammarSymbols.TRUE);
//		this.table.put(new Key(0, "program"), GrammarSymbols.PROGRAM);
//		this.table.put(new Key(0, "function"), GrammarSymbols.FUNCTION);
//		this.table.put(new Key(0, "begin"), GrammarSymbols.BEGIN);
//		this.table.put(new Key(0, "end"), GrammarSymbols.END);
//		this.table.put(new Key(0, "do"), GrammarSymbols.DO);
//		this.table.put(new Key(0, "then"), GrammarSymbols.THEN);
//		this.table.put(new Key(0, "var"), GrammarSymbols.VAR);
